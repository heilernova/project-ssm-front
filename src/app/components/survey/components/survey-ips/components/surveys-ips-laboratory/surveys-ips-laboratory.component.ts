...
@Component({
  selector: 'app-surveys-ips-laboratory',
  templateUrl: './surveys-ips-laboratory.component.html',
  styleUrls: ['./surveys-ips-laboratory.component.scss']
})
export class SurveysIpsLaboratoryComponent implements OnInit {
